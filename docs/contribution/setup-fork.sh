...
# upstream   https://github.com/pfassina/ProxmoxVED.git (fetch)
# upstream   https://github.com/pfassina/ProxmoxVED.git (push)
```
...
print_info "Upstream: https://github.com/pfassina/ProxmoxVED"
echo ""
